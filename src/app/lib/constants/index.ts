...
export const SOUNDS = [
    { id: 'sound1', src: '/sound/alarm-clock.mp3', label: 'Alarm Clock' },
    { id: 'sound2', src: '/sound/doorbell-notification.mp3', label: 'Dorbell notification' },
    { id: 'sound3', src: '/sound/simple-notification.mp3', label: 'Simple Notification' },
];
